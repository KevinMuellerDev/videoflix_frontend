...
import styles from '@/pages/privacypolicy/index.module.css';
    ...
    <>
      <main className={styles.privacyContent}>
        <div className={styles.privacy}>
          <h1 className={styles.privacyHeadline}>Datenschutzerklärung</h1>
          <br />
          ...
          E-Mail-Adresse: info&#64;kevin-mueller.dev.de
          <br />
          Impressum:{' '}
          <a
            href="https://www.kevin-mueller-dev.de/#/impressum"
            target="_blank"
          >
            https://www.kevin-mueller-dev.de/#/impressum
          </a>
          <br />
          <br />
          ...
          <p>
            ...
            den Nutzern eine vorhergehende Einwilligung ein, es sei denn, sie
            ...
            sind, um den Nutzern einen von ihnen ausdrücklich gewünschten
            Telemediendienst (also unser Onlineangebot) zur Verfügung zu
            stellen. Die widerrufliche Einwilligung wird ihnen gegenüber
            deutlich kommuniziert und enthält die Informationen zur jeweiligen
            Cookie-Nutzung.
          </p>
          <br />
          <p>
            ...
            Auf welcher datenschutzrechtlichen Grundlage wir die
            personenbezogenen Daten der Nutzer mithilfe von Cookies verarbeiten,
            hängt davon ab, ob wir sie um eine Einwilligung bitten. Falls die
            Nutzer akzeptieren, ist die Rechtsgrundlage der Verwertung ihrer
            ...
            Onlineangebots und der Verbesserung seiner Nutzbarkeit) verarbeitet
            oder, falls dies im Rahmen der Erfüllung unserer vertraglichen
            Pflichten erfolgt, wenn der Einsatz von Cookies erforderlich ist, um
            unseren vertraglichen Verpflichtungen nachzukommen. Zu welchen
            Zwecken die Cookies von uns verwertet werden, darüber klären wir im
          ...
          <ul className="m-elements">
            <li>
              ...
              die Nutzer sich ansehen oder mit denen sie interagieren, oder die
              von ihnen vorgenommenen Handlungen sowie Informationen über die
              von den Nutzern genutzten Geräte (z. B. IP-Adressen,
              Betriebssystem, Browsertyp, Spracheinstellungen, Cookie-Daten) und
              Angaben aus dem Profil der Nutzer, wie Berufsfunktion, Land,
              ...
              der Daten durch und die Übermittlung an die Ireland Unlimited
              Company, ein Unternehmen mit Sitz in der EU. Die weitere
              Verarbeitung der Daten obliegt ausschließlich der Ireland
              Unlimited Company, was insbesondere die Übermittlung der Daten an
              die Muttergesellschaft LinkedIn Corporation in den USA betrifft;{' '}
